...
export const DOC_REQUEST_ILS =
  "Здравствуйте! Для проверки нужна выписка ИЛС с Госуслуг. Можно прислать файл (PDF/JPG/PNG) прямо в этот чат — примем, специалист увидит. Также можно загрузить в личный кабинет на сайте. Мы готовим документы и план — подаёте через СФР или Госуслуги вы сами. Решение принимает СФР.";

export const DOC_REQUEST_LABOR =
  "Здравствуйте! Подготовьте трудовую книжку или сведения о стаже. Можно прислать сканы (PDF/JPG/PNG) в этот чат или загрузить в личный кабинет на сайте. Мы готовим документы и план — подаёте через СФР или Госуслуги вы сами. Решение принимает СФР.";
