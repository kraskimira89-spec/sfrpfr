...
_TEMPLATES: dict[str, tuple[str, str]] = {
    "request_docs": (
        ...
        (
            ...
            "Пожалуйста, пришлите выписку ИЛС (PDF с Госуслуг) и сканы трудовой "
            "в чат MAX или загрузите в личный кабинет на сайте — "
            "на это письмо вложениями не отвечайте.\n\n"
            "Кабинет: {cabinet_url}\n"
    ...
    "reminder": (
        ...
        (
            "Здравствуйте!\n\n"
            "Напоминаем про дело {case_id}: если документы ещё не переданы — "
            "пришлите их в чат MAX или загрузите в личном кабинете на сайте "
            "({cabinet_url}).\n\n"
            "С уважением,\nСервис «Проверка стажа»"
        ),
    ),
