...
def _docs_request_text(*, has_docs: bool) -> str:
    if has_docs:
        return (
            "Откройте раздел «Мои документы» на сайте и загрузите следующий файл. "
            "Вопросы пишите в этом чате."
        )
    return (
        "Получите выписку ИЛС, затем загрузите её через раздел «Мои документы» на сайте. "
        "Вопросы пишите в этом чате."
    )
