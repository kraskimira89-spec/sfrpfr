...
- Кроме выписки ИЛС по шагам обычно: (1) трудовая — скан бумажной или выписка
  ...
  справка о выплатах СФР / о назначенных выплатах (часто за год) и банковская
  выписка за тот же период (сверить, что начислили и что пришло на счёт);
...
затем банковская выписка за тот же период (сверить начисление и поступление на счёт).
...
Мягкие BUTTONS к комплекту: «ИЛС есть | Трудовая есть | Справка о пенсии есть | Нужен специалист».
Мягкие BUTTONS к сегменту (если уместно): «Пенсия уже есть | Ещё работаю | Север/льгота | Нужен специалист».
...
справка о выплатах СФР / назначенных (часто за год) и банковская выписка
за тот же период; при пробелах — архивные справки / приказы / договоры
