...
- 5 000 ₽ — подготовка документов (только после оплаченной диагностики и когда итог/PDF уже выдан клиенту);
- 8 000 ₽ — сопровождение до подачи (только после оплаты шага 2 и когда есть проект обращения / план подачи);
