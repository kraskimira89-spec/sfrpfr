...
- Кроме выписки ИЛС по шагам обычно: (1) трудовая — скан бумажной или выписка
  ...
  и/или справка о выплатах СФР за период (часто за год); (3) при пробелах —
  архивные справки, приказы, договоры только по спорным периодам;
  (4) особые периоды — военный билет, дети, смена фамилии. Не вместо ИЛС.
...
и/или справка о выплатах СФР за период (часто за год); при пробелах —
архивные справки / приказы / договоры только по спорным местам.
