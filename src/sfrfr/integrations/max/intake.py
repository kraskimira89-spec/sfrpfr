...
DOCS_INFO_TEXT = (
    ...
    "справка о выплатах СФР за период (часто за год) и/или о назначенных выплатах, "
    "плюс банковская выписка за тот же период: чтобы сверить, что начислили "
    "и что пришло на счёт.\n"
...
DOCS_SPECIAL_TEXT = (
    ...
    "• «Справка о выплатах СФР» / «за период» (часто за год / 12 месяцев);\n"
    "• «Справка о размере пенсии» или о назначенных выплатах "
    "(или блок о пенсии внутри выписки ИЛС);\n"
    "• банковская выписка по счёту пенсии за тот же период — "
    "сверить, что начислили и что пришло на счёт;\n"
...
DOCS_GOSUSLUGI_TEXT = (
    ...
    "4. Если пенсия назначена — «Справка о выплатах СФР» (период, часто за год) "
    "и/или «Справка о размере пенсии» / о назначенных выплатах; "
    "рядом — банковская выписка за тот же период (из банка, не с Госуслуг).\n"
