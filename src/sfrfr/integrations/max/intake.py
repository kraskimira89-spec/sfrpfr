...
# Части приветствия: отправляются с паузой (см. WELCOME_PART_DELAY_SECONDS).
WELCOME_PART_1 = (
    "Здравствуйте!\n\n"
    "Я бот сервиса «Проверка стажа». Здесь можно:\n"
    "• коротко уточнить ситуацию — за себя или помочь близкому;\n"
    "• понять, какие документы нужны для сверки стажа и ИЛС;\n"
    "• написать вопрос в едином чате и позвать специалиста.\n\n"
    "Для кого проверка? Выберите кнопку под этим сообщением."
)

WELCOME_PART_2 = (
    "Документы (ИЛС, трудовую и др.) можно прислать прямо в этот чат — PDF или фото. "
    "Также можно через раздел «Мои документы» на сайте. "
    "Вопросы пишите прямо здесь."
)

WELCOME_PART_3 = (
    "Для кого проверка? Выберите кнопку ниже.\n"
    "Если ответ не появился сразу, не нажимайте повторно — выбор уже обрабатывается."
)

WELCOME_TEXT = f"{WELCOME_PART_1}\n\n{WELCOME_PART_2}\n\n{WELCOME_PART_3}"

# Пауза между частями приветствия (секунды). В тестах можно поставить 0.
WELCOME_PART_DELAY_SECONDS = 60
...
def format_welcome_text(*, display_name: str | None = None) -> str:
    """Полный текст приветствия (для тестов/совместимости)."""
    return "\n\n".join(welcome_parts(display_name=display_name))
...
FALLBACK_MENU_TEXT = (
    ...
    "Документы можно прислать в этот чат или через «Мои документы» на сайте."
)
...
SUMMARY_TEXT = (
    ...
    "Также можно открыть раздел «Мои документы» на сайте. "
...
DOCS_INFO_TEXT = (
    ...
    "Документы можно прислать прямо в этот чат или загрузить через раздел "
    "«Мои документы» на сайте. "
...
DOCS_STAZH_TEXT = (
    ...
    "Готовые файлы пришлите в этот чат или загрузите через «Мои документы» в кабинете."
)
...
DOCS_GOSUSLUGI_TEXT = (
    ...
    "Сохраните файл и пришлите в этот чат или загрузите через «Мои документы» на сайте."
)
...
ILS_HOWTO_TEXT = (
    ...
    "Когда файл будет готов, пришлите его в этот чат или загрузите через «Мои документы» на сайте."
)
...
ILS_HOWTO_MFC_TEXT = (
    ...
    "в этот чат или загрузите через «Мои документы» на сайте."
)
...
OPERATOR_CONFIRM_TEXT = "Передали запрос специалисту. Ответим в этом чате."

# Успешный приём вложения в чат MAX (канал чат-бот).
...
UPLOAD_BLOCKED_TEXT = (
    ...
    "или загрузите через раздел «Мои документы» "
    "в защищённом личном кабинете на сайте."
)
...
def documents_upload_keyboard(*, cabinet_url: str | None) -> list[dict[str, Any]]:
    """Кнопка в раздел «Мои документы» (альтернатива загрузке в чат MAX)."""
    from sfrfr.services.case_chat_delivery import DOCUMENTS_SECTION_LABEL
...
def free_text_nudge(*, intake: MaxIntakeRecord | None = None) -> tuple[str, list[dict[str, Any]]]:
    ...
    if step == "pension":
        ...
        hint = (
            "Можно прислать файлы в этот чат, открыть «Мои документы» на сайте "
