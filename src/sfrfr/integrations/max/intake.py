...
WELCOME_TEXT = (
    ...
    "• написать вопрос в едином чате — в MAX или в кабинете на сайте;\n"
    "• позвать специалиста в этот же чат.\n\n"
    "Чат по делу — один и тот же в кабинете и MAX. Пишите там, где удобнее: "
    "в кабинете на компьютере или телефоне либо в MAX. Все сообщения будут в одной истории.\n\n"
    "В чат можно написать вопрос. Выписку ИЛС, трудовую книжку и другие личные "
...
SUMMARY_TEXT = (
    ...
    "(после согласия на обработку данных). Вопросы можно писать в этом же чате MAX "
    "или в кабинете: история будет общей. "
