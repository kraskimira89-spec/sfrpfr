...
DOCS_STAZH_TEXT = (
    ...
    "Готовые документы загружайте только через раздел «Мои документы» в кабинете."
)
...
DOCS_GOSUSLUGI_TEXT = (
    ...
    "Сохраните файл и загрузите его через раздел «Мои документы» в кабинете на сайте."
)
...
ILS_HOWTO_TEXT = (
    ...
    "Когда файл будет готов, загрузите его через раздел «Мои документы» в кабинете на сайте."
)
...
ILS_HOWTO_MFC_TEXT = (
    ...
    "Когда выписка будет — нажмите «Уже получил(а) — дальше» и загрузите её "
...
# Вложения из MAX не попадают в дело: документы принимаются только через сайт.
UPLOAD_BLOCKED_TEXT = (
    "Спасибо. Для защиты данных файл не добавлен к делу.\n"
    "Пожалуйста, загрузите его через раздел «Мои документы» "
    "в защищённом личном кабинете на сайте."
)
# Совместимость со старыми импортами; новое поведение — отказ вложения.
UPLOAD_ACCEPTED_TEXT = UPLOAD_BLOCKED_TEXT
