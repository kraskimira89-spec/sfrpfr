...
WELCOME_TEXT = (
    "Здравствуйте! Поможем разобраться со стажем и документами для СФР. "
    "Решение о пенсии и перерасчёте принимает СФР. С чего начнём?"
)
...
SUMMARY_TEXT = (
    ...
    "Перед загрузкой потребуется согласие на обработку данных. Решение принимает СФР."
)
...
DOCS_INFO_TEXT = (
    ...
    "Документы принимаются только в личном кабинете, не в этом чате. Решение принимает СФР."
)

OPERATOR_CONFIRM_TEXT = "Передали запрос специалисту. Ответим в этом чате. Решение принимает СФР."
