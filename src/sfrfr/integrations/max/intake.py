...
DOCS_INFO_TEXT = (
    ...
    "и/или справка о выплатах СФР за период (часто за последние 12 месяцев / за год); "
    "при сверке выплат смотрят и сведения о назначенных выплатах.\n"
    "3) Если в ИЛС периоды «не сходятся» с реальной работой — "
    "архивные справки, приказы, трудовые договоры только по спорным местам.\n"
    "4) Особые периоды — военный билет, свидетельства о детях, смена фамилии "
