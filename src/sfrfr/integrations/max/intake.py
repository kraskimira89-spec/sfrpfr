...
WELCOME_TEXT = (
    ...
    "Не присылайте файл в этот чат — только кабинет на сайте.\n\n"
...
DOCS_INFO_TEXT = (
    "Документы для проверки стажа — краткий ориентир.\n\n"
    ...
    "Загружайте файлы в личный кабинет на сайте — так защищённее. "
    "Не присылайте файлы в этот чат.\n\n"
    f"{POSITION_SHORT}"
)
...
DOCS_STAZH_TEXT = (
    "Если в ИЛС периоды неполные, для подтверждения могут понадобиться:\n"
...
DOCS_SPECIAL_TEXT = (
    ...
    "• свидетельства о рождении детей (уход до 1,5 лет); "
    ...
    "• решение/постановление органа опеки — плюс документы по основанию ухода;\n"
    "• свидетельство о браке — смена фамилии;\n"
    "• документы об образовании — при необходимости;\n"
    "• льготный/северный стаж — СОУТ, архивные приказы.\n\n"
    "С Госуслуг часто дополнительно:\n"
    "• «Справка о выплатах СФР» / «за период» (часто последние 12 месяцев);\n"
    "• «Справка о размере пенсии» или блок о пенсии внутри выписки ИЛС;\n"
...
DOCS_GOSUSLUGI_TEXT = (
    ...
    "4. При необходимости — «Справка о выплатах СФР» (период, часто 12 месяцев) "
    ...
    "Готовые файлы только в личный кабинет на сайте; "
    "не в этот чат."
)
...
DOCS_MISSING_TEXT = (
    ...
    "• Ликвидированное предприятие — сначала ИЛС; при пробеле — госархив → справки → СФР.\n"
...
ILS_HOWTO_TEXT = (
    ...
    "Файл загрузите в личный кабинет на сайте; "
    "не в этот чат.\n\n"
    f"{POSITION_SHORT}"
)
