...
DOCS_CHANNEL_CANON = (
    "Вложения клиент может прислать прямо в этот чат MAX "
    "(переписка с ботом / чат с сотрудником) — примем, специалист увидит. "
    "Не пиши «загрузите в личный кабинет» / mini-app как основной способ "
    "прислать ИЛС, трудовую или выписки. "
    "Кабинет клиента — только сайт cabinet.proverkastaza.ru "
    "(статус, оплата, согласие); не путай его с загрузкой вложений в MAX."
)
...
что их можно прислать в этот чат MAX.
