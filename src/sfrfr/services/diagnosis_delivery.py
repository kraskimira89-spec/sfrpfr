...
def build_max_result_ready(*, secure_link: str) -> str:
    body = (
        ...
        f"{secure_link}\n\n"
        "В документе: что проверено, какие вопросы и расхождения, какой план дальше.\n"
        "Сейчас пришлём краткие рекомендации и предложим составить отдельные "
        "обращения в СФР (по одному вопросу — так проще отслеживать ответы).\n\n"
