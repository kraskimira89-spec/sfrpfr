    ...
    *,
    ...
    if preferred == "web_cabinet":
        channel_hint = (
            ...
            "или в MAX — введите его в личном кабинете на сайте. Сканы — только там."
        )
    elif preferred == "max_miniapp":
        channel_hint = (
            "Вы выбрали MAX для связи. Откройте бота для подсказок; "
            "документы и регистрация — в личном кабинете на сайте "
            "(код входа может прийти в MAX или на почту). Сканы — только в кабинете на сайте."
        )
    else:
        channel_hint = (
            "Зарегистрируйтесь в личном кабинете на сайте: код входа придёт на почту или в MAX. "
            "Сканы документов — только в кабинете на сайте, не через форму и не в чат."
        )
