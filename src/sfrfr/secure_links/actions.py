...
def grant_consent_via_token(
    ...
    *,
    ...
    return {
        ...
        "message": (
            "Согласие принято. Документы можно прислать в чат MAX "
            "или загрузить в «Мои документы» в кабинете на сайте."
        ),
    }
...
def _hint_for(purpose: str) -> str:
    if purpose == "consent":
        return (
            ...
            "Решение принимает СФР. Документы можно прислать в чат MAX "
            "или загрузить в кабинете на сайте."
        )
    if purpose == "view_pdf":
        return (
