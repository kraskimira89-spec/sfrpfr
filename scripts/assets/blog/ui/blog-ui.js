(function () {
  ...
  function insertMidCta() {
    ...
    cta.innerHTML =
      ...
      '<p class="sfrfr-blog-cta__text">Мы готовим документы и план — подаёте через СФР или Госуслуги вы сами. Решение принимает СФР. Начните в личном чате MAX или оставьте заявку; сканы через форму сайта не загружайте.</p>' +
