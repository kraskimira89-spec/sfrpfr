...
function sfrfr_seo_description(): string
{
    ...
    if (is_singular()) {
        ...
        $pageDescriptions = [
            ...
            'otzyvy' => 'Отзывы о сервисе «Проверка стажа»: Яндекс Карты или короткая обратная связь. Цитаты на сайте — только с согласия и после проверки.',
            ...
            'kak-podat-zayavlenie-cherez-gosuslugi-ili-mfc' => 'Как выбрать способ подачи в СФР: электронная услуга, интернет-обращение или клиентская служба. Госуслуги — основной дистанционный маршрут, МФЦ — запасной канал.',
