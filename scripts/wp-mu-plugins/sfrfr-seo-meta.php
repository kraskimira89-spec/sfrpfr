...
function sfrfr_seo_description(): string
{
    ...
    if (is_singular()) {
        ...
        $pageDescriptions = [
            ...
            'kak-proverit-stazh-v-vypiske-ils' => 'Как проверить трудовой стаж по выписке ИЛС без «калькулятора выплат»: периоды, расхождения и план. Сумму пенсии назначает только СФР.',
            'kak-sverit-trudovuyu-knizhku-i-ils' => 'Расчёт трудового стажа онлайн не заменяет сверку трудовой книжки с ИЛС. Как сравнить периоды и что делать при расхождении.',
