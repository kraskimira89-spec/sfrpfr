...
$settings = [
    ...
    'confirmations'            => [
        '1' => [
            'type'           => 'message',
            'message'        => 'Спасибо! Мы свяжемся с вами. Не отправляйте сканы в чат или через форму сайта — документы загружаются только в защищённом личном кабинете после согласия.',
            'message_scroll' => '1',
        ],
    ],
];
