...
$pages = [
    ...
    [
        ...
        'title' => 'Папка пенсионных документов',
        'file' => 'chek-list-dokumentov.html',
        'seo_title' => 'Папка пенсионных документов: чек-лист до обращения в СФР',
        'seo_description' => 'Бесплатный чек-лист: собрать документы для проверки стажа, получить выписку ИЛС и отметить расхождения. Без сканов в чат и без обещания перерасчёта.',
    ],
    [
