...
$pages = [
    ...
    [
        ...
        'title' => 'Северный стаж для пенсии: проверка периодов',
        'file' => 'proverka-severnogo-stazha.html',
        'seo_title' => 'Северный стаж для пенсии и районы Крайнего Севера',
        'seo_description' => 'Северный стаж для пенсии: сверка периодов в районах Крайнего Севера и приравненных местностях. Без обещания льготы и суммы — решение принимает СФР.',
    ],
    [
