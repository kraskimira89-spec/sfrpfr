...
$fields = [
    ...
    '3' => [
        ...
        'description' => 'Обязательно для рассмотрения обращения. Не является согласием на рекламу.',
        'choices' => [
            '1' => [
                'label' => 'Принимаю Политику обработки персональных данных и согласен(на) на обработку данных для рассмотрения обращения*',
                'value' => '1',
                'image' => '',
            ],
        ],
    ...
    '7' => [
        'id' => '7',
        'type' => 'checkbox',
        'label' => 'Информационные и рекламные сообщения (необязательно)',
        'description' => 'Не обязательно для заявки и услуги. Можно отозвать в любое время (СТОП в MAX).',
        'choices' => [
            '1' => [
                'label' => 'Согласен(на) получать в MAX информационные и рекламные сообщения ООО «Под присмотром» о сервисе «Проверка стажа». Согласие можно отозвать.',
                'value' => 'marketing_max',
                'image' => '',
            ],
        ],
        'required' => '0',
        'choices_images' => '0',
        'css' => 'sfrfr-lead-marketing-consent',
    ],
    '4' => [
        'id' => '4',
        'type' => 'text',
