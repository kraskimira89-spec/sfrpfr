...
$articles = [
    [
        ...
        'seo_title' => 'Проверить стаж в ИЛС: не калькулятор пенсии, а сверка',
        'seo_description' => 'Как проверить трудовой стаж по выписке ИЛС без «калькулятора выплат»: периоды, расхождения и план. Сумму пенсии назначает только СФР.',
        'related' => [
    ...
    [
        ...
        'seo_title' => 'Калькулятор стажа vs сверка трудовой и ИЛС',
        'seo_description' => 'Расчёт трудового стажа онлайн не заменяет сверку трудовой книжки с ИЛС. Как сравнить периоды и что делать при расхождении.',
        'related' => [
            'kak-zakazat-vypisku-ils',
            'kak-proverit-stazh-v-vypiske-ils',
            'chto-delat-esli-period-raboty-ne-uchten',
    ...
    [
        ...
        'category' => 'stazh',
        'excerpt' => 'Северный стаж для пенсии: сверка периодов в трудовой и ИЛС, если северный стаж не учли.',
        'seo_title' => 'Северный стаж для пенсии: что сверить',
        'seo_description' => 'Северный стаж для пенсии: что сверить в трудовой и ИЛС, если северный стаж не учли. Без обещания перерасчёта.',
        'related' => [
            'kak-proverit-stazh-v-vypiske-ils',
            'chto-delat-esli-period-raboty-ne-uchten',
