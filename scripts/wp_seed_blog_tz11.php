...
$articles = [
    ...
    [
        ...
        'title' => 'Как подать заявление: Госуслуги, СФР и МФЦ',
        'category' => 'podacha',
        'excerpt' => 'Как выбрать способ подачи: сначала Госуслуги, затем СФР; МФЦ — только если услуга доступна в регионе.',
        'seo_title' => 'Как подать заявление в СФР: Госуслуги и МФЦ',
        'seo_description' => 'Как выбрать способ подачи в СФР: сначала Госуслуги, затем обращение в СФР; МФЦ — только при доступности услуги в регионе.',
        'related' => [
            'kakie-dokumenty-sobrat-do-obrashcheniya-v-sfr',
            'chek-list-pered-zapisju-v-mfc',
    ...
    [
        ...
        'title' => 'Отказ СФР в назначении пенсии: что проверить',
        'category' => 'podacha',
        'excerpt' => 'Отказ СФР в назначении пенсии: что выписать из ответа и как готовить повторное обращение без обещания исхода.',
        'seo_title' => 'Отказ СФР в назначении пенсии: что проверить',
