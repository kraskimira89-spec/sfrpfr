...
$articles = [
    ...
    [
        ...
        'category' => 'stazh',
        'excerpt' => 'Северный стаж для пенсии, районы Крайнего Севера и приравненные: сверка, если северный стаж не учли.',
        'seo_title' => 'Северный стаж для пенсии: что сверить',
        'seo_description' => 'Северный стаж для пенсии, Крайний Север и приравненные местности: что сверить в трудовой и ИЛС. Без обещания перерасчёта.',
        'related' => [
            'kak-proverit-stazh-v-vypiske-ils',
            'chto-delat-esli-period-raboty-ne-uchten',
