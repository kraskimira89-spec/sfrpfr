...
| Пт | Заполнить CSV или таблицу ниже; комментарий в FUNNEL-2 |

**CSV-шаблон:** `docs/marketing-sales/reports/funnel-lead-sla-weekly.csv` (без ФИО/телефона; `case_ref` — последние 4 символа id).
