# Ops: миграции prod TZ27–31 (SFRFR-17…22 + archive_prep)

**Статус:** **применены на prod** (ревизии 2026-09-02). Чеклист ниже — история apply + verify.  
**Дата чеклиста:** 2026-08-23  
**Очередь:** SFRFR-17 … SFRFR-22 + `20260823240000_cases_archive_prep.sql`
