...
|---|---|---|---|---|---|---|
| Не учли / пропал стаж в ИЛС | `/blog/chto-delat-esli-period-raboty-ne-uchten/` + **`/ne-uchli-stazh/`** | `/ne-uchli-stazh/` | проблемный | разобрать / услуга | **live** commercial + blog | 2026-08-19 |
| Стаж до 2002 | `/stazh-do-2002/` | `/stazh-do-2002/` | проблемный | чек-лист | **live** trust | 2026-08-14 |
| Архивная справка | `/blog/arhivnaya-spravka-dlya-sfr-zachem-i-kuda/` + **`/arhivnaya-spravka-stazh/`** | `/arhivnaya-spravka-stazh/` | транзакционный | чек-лист | **live** commercial + blog | 2026-08-19 |
...
| Отказ СФР | `/blog/otkaz-sfr-chto-proverit-v-dokumentah/` + **`/otkaz-sfr/`** | `/otkaz-sfr/` | горячий | разобрать | **live** commercial + blog | 2026-08-19 |
