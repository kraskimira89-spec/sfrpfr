...
5. При e-mail — письмо с перечнем и ссылкой; маркетинг не шлётся без отдельного согласия.  
6. Микродействия после: **«ИЛС получил(а)»** / **«Есть расхождение»** / **«Нужна проверка документов»**.
