...
2. **Анкета** — кнопка **Яндекс Форма** → https://forms.yandex.ru/cloud/6a7db97670ad3712589c7456/  
3. **Оставить отзыв** — форма внизу страницы (текст + SmartCaptcha + согласие) → очередь модерации (`pending`).
