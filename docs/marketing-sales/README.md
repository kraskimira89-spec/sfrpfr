...
7. **Яндекс Бизнес:** канон прайса `82469923047` (4 позиции = YML/сайт); дубликат `234170727274` ещё в ссылках на отзывы. Публичная сверка 2026-08-12: отзывов у обеих нет. До слияния в кабинете ссылки не менять. См. `docs/ops/yandex-business-profile.md`, `docs/history/2026-08-12-yandex-business-dual-cards.md`.
