...
- [Стратегия LLM → тарифы 5 000 / 8 000 ₽](strategy-llm-tariffs-5000-8000.md) — ворота после диагностики; ясность, не давление; связь с kanban (ТЗ-33).
...
- [**Стратегия: реклама → канал MAX → «Подать заявку»**](strategy-ads-to-max-channel-2026-09.md) — платный охват на подписку; с каждого поста в личный чат до результата.
...
- Архивный запрос (оффер MAX): [`scripts/assets/copy/archive-request-offer.md`](../../scripts/assets/copy/archive-request-offer.md) — playbook [архив](playbook-archive-request-prep.md).
