...
Bot-owned воронка (документы → счёт → оплата/чек → расхождения пунктами → план со специалистом):
`src/sfrfr/services/max_bot_funnel.py`, история `docs/history/2026-09-22-max-bot-funnel-docs-pay-plan.md`.
