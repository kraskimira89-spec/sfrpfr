...
36. [36-sfr-client-chatbot-tz-v1.md](36-sfr-client-chatbot-tz-v1.md) — единое ТЗ v1.0 клиентского чат-бота: отдельное согласие ПДн, анкета, личное дело CASE-…, документы, бесплатная проверка, 5 000 / 8 000 ₽, этапы A–F.
