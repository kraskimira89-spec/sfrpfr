...
WordPress — только маркетинг и правовые страницы. Персональные данные, документы и работа по пенсионным делам обрабатываются только через отдельные защищённые кабинеты и API.
