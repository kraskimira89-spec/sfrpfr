...
Фаза 3: сравнить с собственным admin dashboard
Фаза 4: решить — оставить dbt Core или пилотировать T2
Фаза 5: при необходимости POC независимого российского BI
```
