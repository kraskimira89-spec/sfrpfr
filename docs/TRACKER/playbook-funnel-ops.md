...
**Статус очереди (2026-09):** FUNNEL-6/7/8/9/10 закрыты частично по истории; **FUNNEL-2 / 4 / 5** часто ждут owner UI / оператора (SLA, доска, clarity-разбор). Не закрывать их агентом без скрина/отчёта владельца.
