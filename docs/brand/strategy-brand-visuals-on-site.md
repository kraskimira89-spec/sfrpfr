...
### Сейчас (готово в репо)
- Ассеты и брифы лежат в `docs/brand/`.
- На live-витрине по-прежнему SVG чек-листа на главной.

### Шаг A — P2 главная (после утверждения family 16:9)
