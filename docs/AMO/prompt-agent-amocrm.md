...
- Возражения «дорого»/«нет денег» — clarity-funnel §5/§5б/§5в: чек-лист как первый шаг; при молчании — «Ожидаем клиента» + 2 касания (не LOSS сразу); без рекламной досылки без согласия.
