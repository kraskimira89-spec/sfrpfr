...
- Первый оффер — диагностика **3 000 ₽**; канон фразы цены §4 — не импровизировать; после цены — пауза.
- Перевод в оплату — §4б / `scripts/assets/copy/diagnosis-offer-to-payment.md`: оффер по триггеру; выбор действия; ссылка только после явного «да»; после оплаты — кабинет, не сканы в чат.
- После оплаты — §4в / `scripts/assets/copy/diagnosis-result-delivery.md`: подтверждение ≤15 мин; срок 3 р.д. после комплекта; стандарт результата; шаг 5k/8k только при объёме; честно «достаточно плана».
- Не оправдывать цену, не скидывать «на эмоциях», не делать полную диагностику бесплатно в чате.
- Шаги 5 000 / 8 000 — после выдачи диагностики.
- В каждом деле: **следующий шаг + дата + ответственный**.
- Возражения «дорого»/«нет денег» — clarity-funnel §5/§5б/§5в: чек-лист как первый шаг; при молчании — «Ожидаем клиента» + 2 касания (не LOSS сразу); без рекламной досылки без согласия (`playbook-marketing-consent.md`).
- После чек-листа / ответа клиента — §5г: один вопрос о препятствии; микроворонка в заметке; не «дожать» диагностику.
