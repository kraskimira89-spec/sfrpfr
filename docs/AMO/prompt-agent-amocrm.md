...
- Возражения «дорого»/«нет денег» — clarity-funnel §5/§5б: чек-лист как первый безопасный шаг (`ils-self-check-checklist.md`); тег `self-service-checklist`; команды `ИЛС получил(а)` / `Нужна проверка`; без спора и скидки.
