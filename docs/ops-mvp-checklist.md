...
|---|---|---|
| 1. Публичный вход | ✅ | WP: оферта/ПДн/согласие; CTA `/#kak-rabotat`; форма без СНИЛС/файлов; `POST /api/public/leads` → case + amoCRM |
...
| 6. CRM и аналитика | ✅ | amoCRM sync; Sheets whitelist без ПДн |

## Операционный запуск этапа 1

1. В `.env` API: `PUBLIC_LEAD_TOKEN=…`, `AMO_ACCESS_TOKEN=…`
